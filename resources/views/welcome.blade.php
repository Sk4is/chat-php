                ...
                <div class="relative w-full min-h-screen">
                    <header class="grid grid-cols-2 items-center justify-between gap-2 py-5">
                        ...
                        <div class="logo">
                            ...
                            <img src="{{ asset('storage/peaxie-fairy-violet.png') }}" alt="Pixie-logo" class="size-20 rounded-full object-cover align-center">

                        </div>
                        @if (Route::has('login'))
                            <nav class="flex flex-1 justify-end gap-5 mx-5">
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
                                ...
                                @else
                                    <div class="bg-blue-6 rounded-3xl  text-white ring-1 ring-transparent transition hover:text-blue-2 focus:outline-none focus-visible:ring-blue-2 h-10 flex items-center justify-center">
                                        <a
                                        href="{{ route('login') }}"
                                        class="px-10 py-2"
                                        >
                                    ...
                                    @if (Route::has('register'))
                                        <div class="bg-blue-6 rounded-3xl text-white ring-1 ring-transparent transition hover:text-blue-2 focus:outline-none focus-visible:ring-blue-2 h-10 flex items-center justify-center">
                                            <a href="{{ route('register') }}" class="px-10 py-2">
                                                Register
                                            </a>
                                        </div>
                                    @endif
                    ...
                    <main class="mt-6">
                        <div class="">
                            ...
                            <h1 class="text-white text-6xl lg:text-8xl font-semibold text-center my-10" >Welcome to BreezeFlow chat</h1>
